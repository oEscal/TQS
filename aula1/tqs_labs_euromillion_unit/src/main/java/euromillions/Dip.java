...
public class Dip {
    ...
    private static final int MAX_NUM_STARS = 2;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (MAX_NUM_NUMBERS == arrayOfNumbers.length && MAX_NUM_STARS == arrayOfStarts.length) {
